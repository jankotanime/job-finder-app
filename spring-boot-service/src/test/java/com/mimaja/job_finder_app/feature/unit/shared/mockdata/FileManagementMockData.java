...
public class FileManagementMockData {
    ...
    public static final String TEST_STORAGE_KEY =
            "documents/cvs/12345678-1234-1234-1234-123456789012-test-document.pdf";
    ...
    public static final String TEST_PHOTO_STORAGE_KEY =
            "photos/offer-photos/87654321-4321-4321-4321-210987654321-test-photo.jpg";
    ...
    public static ProcessedFileDetails createTestProcessedFileDetailsWithMimeType(
            MimeType mimeType) {
        return new ProcessedFileDetails(
                TEST_FILE_NAME,
                TEST_CONTENT_TYPE,
