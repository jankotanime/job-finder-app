...
import com.fasterxml.jackson.databind.ObjectMapper;import com.mimaja.job_finder_app.core.handler.exception.BusinessExceptionReason;
            ...
            try {
                ...
                if ((request.getServletPath().equals("/profile-completion-form")
                    ...
                    // TODO: To Business exception
                        ...
                        errorBody.put("message", BusinessExceptionReason.PROFILE_INCOMPLETE.getMessage());
                        new ObjectMapper()
