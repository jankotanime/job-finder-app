...
public class PasswordWebisteManageController {
  ...
  @PutMapping("/update")
  public ResponseDto<ResponseTokenDto> updatePasswordPostMapping(@RequestBody RequestPasswordUpdateByEmailDto reqData) {
  ...
  public ResponseDto<ResponsePasswordUpdateEmailRequestDto> sendEmailPutMapping(@RequestBody RequestPasswordUpdateEmailRequestDto reqData) {
    ResponsePasswordUpdateEmailRequestDto result = passwordWebsiteManageServiceDefault.sendEmailWithUpdatePasswordRequest(reqData);
