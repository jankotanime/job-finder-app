...
public enum BusinessExceptionReason implements BusinessExceptionPolicy {
    ...
    CONTRACT_NOT_FOUND("Contract not found", HttpStatus.NOT_FOUND, null),
    CONTRACT_BELONGS_TO_JOB("Contract belongs to job", HttpStatus.FORBIDDEN, null),
    ...
    JOB_NOT_FINISHED("Job is not finished", HttpStatus.FORBIDDEN, null),
    JOB_NOT_FOUND("Job not found", HttpStatus.NOT_FOUND, null),
    JOB_NOT_READY("Job is not ready", HttpStatus.FORBIDDEN, null),
    JOB_NOT_STARTED("Job has not started", HttpStatus.FORBIDDEN, null),
    JOB_NOT_UNREADY("Job is not unready", HttpStatus.FORBIDDEN, null),
    JOB_NOT_IN_PROGRESS("Job is not in progress", HttpStatus.FORBIDDEN, null),
    ...
    USER_NOT_CANDIDATE("User is not candidate", HttpStatus.FORBIDDEN, null),
    USER_NOT_CONTRACTOR("User is not contractor", HttpStatus.FORBIDDEN, null),
    USERNAME_ALREADY_TAKEN("User with this username exists", HttpStatus.UNAUTHORIZED, null),
    WRONG_DOCUMENT_FILE_FORMAT("Wrong cv file format", HttpStatus.BAD_REQUEST, null),
