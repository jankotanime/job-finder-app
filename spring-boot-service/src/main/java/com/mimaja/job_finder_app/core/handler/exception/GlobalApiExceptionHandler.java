package com.mimaja.job_finder_app.core.handler.exception;import static java.lang.String.format;
...
public class GlobalApiExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ErrorResponseDto> handleUncaughtException(
    ...
    final ErrorResponseDto errorResponseDto =
        ErrorResponseBuilder.build(
            Exception.class.getSimpleName(), HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase());
  ...
  public ResponseEntity<Object> handleConstraintViolationException(
    ...
    final List<FieldValidationErrorsDto> invalidParameters = processInvalidParameters(exception);
  ...
  public ResponseEntity<Object> handleMissingServletRequestPart(
    ...
    final FieldValidationErrorsDto missingPrameterDto =
        FieldValidationErrorsDto.builder()
            ...
            .message(
                format("Missing query parameter with name '%s'", exception.getRequestPartName()))
            .build();
  ...
  public ResponseEntity<Object> handleTypeMismatch(
    ...
    final ErrorResponseDto errorResponseDto =
        ErrorResponseBuilder.build(
            ...
            List.of(
                new FieldValidationErrorsDto(ErrorCode.BAD_REQUEST, parameter, "Unexpected type")));
